...
public class DataSupport extends SQLiteOpenHelper {
	 ...
	 * @return
	 */
	public Cursor selectbetweenday(String type, String history,
			String datestart, String dateover) {
		SQLiteDatabase db = getReadableDatabase();
	 ...
	 * @return
	 */
	public Cursor selectBettweenstart(String datestart, String datestop,
			String type) {
		...
		Cursor cursor = db.rawQuery(sql, new String[] { type, datestart,
				datestop });
		// if (MainActivity.isLog) {
	 ...
	 * @return
	 */
	public Cursor selectBettweenstop(String datestart, String datestop,
			String type) {
	...
	public void insertNow(long liuliang, String type, String typename,
		...
		db.execSQL(insertstr,
				new Object[] { liuliang, type, typename, history });
		db.close();
		// if (MainActivity.isLog) {
